      ...
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <div className="max-w-lg pb-16 sm:pb-10 pt-2 relative">
          ...
          <button disabled={loading}
            ...
            className="absolute bottom-1 right-2 text-xs text-white bg-blue-600 px-4 py-1.5 rounded hover:underline cursor-pointer"
          >
            Generate with AI
          </button>
        </div>
        ...
        {/* Submit Button */}
        <button disabled={isAdding} type="submit" className='mt-8 w-40 h-10 bg-blue-800 text-white rounded cursor-pointer text-sm'>
